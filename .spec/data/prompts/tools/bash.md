...
> 来源: OpenCode `packages/opencode/src/tool/bash.ts` + `bash.txt`
> 许可证: MIT
...
| 参数 | 类型 | 必填 | 说明 |
|-----|------|-----|------|
| command | string | 是 | The bash command to execute |
| workdir | string | 否 | Working directory for the command |
| timeout | number | 否 | Timeout in milliseconds (default 120000) |
| description | string | 否 | Brief description of what the command does |
